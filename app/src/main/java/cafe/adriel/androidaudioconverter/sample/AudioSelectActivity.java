...
public class AudioSelectActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.trim_audio);
	...
	class TrimSongAdapter extends BaseAdapter{
		...
		public View getView(final int position, View view, final ViewGroup parent) {
			...
			RelativeLayout relativeLayout= (RelativeLayout) view.findViewById(R.id.MyAudio);
			...
			relativeLayout.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View v) {
					Intent intent=new Intent(AudioSelectActivity.this, TrimAudioActivity.class);
...
//							Toast.makeText(ContactsRingtoneActivity.this, "prev:"+prevTrack+" current:"+currentTrack, Toast.LENGTH_SHORT).show();
							...
							prevImageView.setImageResource(R.drawable.play);
						...
						try {
							mediaPlayer.setDataSource(AudioSelectActivity.this,getUri(position));
							mediaPlayer.prepare();
						} catch (IOException e) {
							e.printStackTrace();
						}
